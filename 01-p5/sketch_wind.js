let winds = [];
let if_hit_by_wind_right = false;
let if_hit_by_wind_left = false;
...
class Wind {
  constructor(pos) {
    ...
    this.y = this.random_pos * 120 + 300;
    this.size = 240;
    this.killed = false;
  }
  ...
  update() {
    ...
    if (
      ...
      if (this.side == "R") {
        if_hit_by_wind_right = true;
      } else {
        if_hit_by_wind_left = true;
      }
